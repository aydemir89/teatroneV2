...
function Login() {
    ...
    return (
        <div className="relative flex h-screen w-screen flex-col bg-black md:items-center md:justify-center md:bg-transparent">
            <Head>
                <title>Teatrone</title>
                <link rel="icon" href="/favicon.ico" />
            </Head>
            <Image
                alt={"logo"}
                src="https://firebasestorage.googleapis.com/v0/b/teatrone.appspot.com/o/items%2FAds%C4%B1z%20tasar%C4%B1m%20(6).png?alt=media&token=73d0ac80-fcff-4b06-9293-681e1f94bb44"
                layout="fill"
            ...
            <form className="relative mt-24 space-y-8 rounded bg-black/75 py-10 px-6 md:mt-0 md:max-w-md md:px-14"
                ...
                <button className="w-full rounded bg-[orange] py-3 font-semibold" onClick={() => setLogin(true)} type="submit">
                    Sign In
                </button>
